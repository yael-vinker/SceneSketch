...
# CUDA_VISIBLE_DEVICES=2 python scripts/ablations/call_run_ratio.py --im_name "man_flowers" --optimize_points 1 --ablation_name "our_results"
# CUDA_VISIBLE_DEVICES=1 python scripts/ablations/call_run_ratio.py --im_name "semi-complex" --optimize_points 1 --ablation_name "our_results"
# CUDA_VISIBLE_DEVICES=3 python scripts/ablations/call_run_ratio.py --im_name "woman_city" --optimize_points 1 --ablation_name "our_results"

# CUDA_VISIBLE_DEVICES=1 python scripts/ablations/call_run_ratio.py --im_name "semi-complex" --optimize_points 1 --ablation_name "fk_step05_fix" --layer 2 --div 0.5
# CUDA_VISIBLE_DEVICES=2 python scripts/ablations/call_run_ratio.py --im_name "semi-complex" --optimize_points 1 --ablation_name "fk_step05_fix" --layer 7 --div 0.5
# CUDA_VISIBLE_DEVICES=3 python scripts/ablations/call_run_ratio.py --im_name "semi-complex" --optimize_points 1 --ablation_name "fk_step05_fix" --layer 8 --div 0.5
# CUDA_VISIBLE_DEVICES=5 python scripts/ablations/call_run_ratio.py --im_name "semi-complex" --optimize_points 1 --ablation_name "fk_step05_fix" --layer 11 --div 0.5
