...
# CUDA_VISIBLE_DEVICES=3 python scripts/all_together/run_ratio.py --im_name "woman_city" --layer_opt 11 --object_or_background "background"
# CUDA_VISIBLE_DEVICES=6 python scripts/all_together/run_ratio.py --im_name "man_flowers" --layer_opt 8 --object_or_background "background" --min_div 0.5
# CUDA_VISIBLE_DEVICES=6 python scripts/all_together/run_ratio.py --im_name "man_flowers" --layer_opt 8 --object_or_background "object" --resize_obj 1 --min_div 0.5
# ====================================================
...
output_pref = "/home/vinker/dev/background_project/experiements/ratio_09_10_fix3" # path to output the results
...
res_filename = f"{args.object_or_background}_l{args.layer_opt}_64s_{os.path.splitext(filename)[0]}"
if args.resize_obj:
...
# save_interval = 10
# num_sketches = 2
# output_pref = f"/home/vinker/dev/background_project/experiements/obj_ratio_03_10_demo/"
# =============================
...
# =============================
use_wandb = 0
wandb_project_name = "ratio_05_10"
num_iter = 501
save_interval = 100
num_sketches = 2
# =============================
...
for i, ratio in enumerate(ratios):
    start_w = time.time()
    test_name_pref = f"l{args.layer_opt}_{num_strokes}s_{os.path.splitext(os.path.basename(file_))[0]}_{args.min_div}"
    if args.resize_obj:
