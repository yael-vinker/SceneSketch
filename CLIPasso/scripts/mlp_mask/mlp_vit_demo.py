...
# width_optim
# ================
# CUDA_VISIBLE_DEVICES=1 python scripts/mlp_mask/mlp_vit_demo.py --image "house_layer4.png" --mlp 0 --clip_conv_loss_type "Cos" --width_optim 1 --width_loss_weight 30 --optimize_points 0 --width_loss_type "L1_hinge"
...
output_pref = f"background_project/experiements/keys_opt_07_11"
