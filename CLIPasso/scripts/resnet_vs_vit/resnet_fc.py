...
# CUDA_VISIBLE_DEVICES=5 python scripts/resnet_vs_vit/resnet_fc.py
...
for im_name in images:
    ...
    test_name = f"{model[:3]}_fc_{num_strokes}s_mask{mask_object_attention}_{os.path.splitext(os.path.basename(file_))[0]}"
    sp.run(["python", 
