...
# CUDA_VISIBLE_DEVICES=6 python scripts/resnet_vs_vit/vit2.py
...
# images = ["yael.jpg", "forest.jpg", "semi-complex.jpeg"]
images = ["assaf.jpg", "complex-scene-crop.png"]
...
for im_name in images:
    ...
    for i in layers:
        ...
        test_name = f"{model[:3]}_l{i}_{num_strokes}s_mask{mask_object_attention}_{os.path.splitext(os.path.basename(file_))[0]}"
        sp.run(["python", 
