...
# ======= commands ========
# =========================
# CUDA_VISIBLE_DEVICES=3 python scripts/simplify/simplify_loss.py --filename "semi-complex-back-l11.png" --res_filename "ViT_l11_64s_semi-complex_mask" --layer_opt 11 --gradnorm 1 --w 2.5
# CUDA_VISIBLE_DEVICES=2 python scripts/simplify/simplify_loss.py --filename "semi-complex-back-l11.png" --res_filename "ViT_l11_64s_semi-complex_mask" --layer_opt 4 --gradnorm 1 --w 1
# CUDA_VISIBLE_DEVICES=1 python scripts/simplify/simplify_loss.py --filename "semi-complex-im.jpeg" --res_filename "ViT_l11_64s_semi-complex_mask" --layer_opt 11 --gradnorm 1 --w 1.6
