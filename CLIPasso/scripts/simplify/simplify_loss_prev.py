...
# ======= commands ========
# =========================
# CUDA_VISIBLE_DEVICES=3 python scripts/simplify/simplify_loss_prev.py --filename "semi-complex-back-l11.png" --res_filename "ViT_l11_64s_semi-complex_mask" --layer_opt 11 --gradnorm 1 --load_points_opt_weights 0
# CUDA_VISIBLE_DEVICES=2 python scripts/simplify/simplify_loss_prev.py --filename "semi-complex-back-l11.png" --res_filename "ViT_l11_64s_semi-complex_mask" --layer_opt 11 --gradnorm 1 --load_points_opt_weights 1
# CUDA_VISIBLE_DEVICES=1 python scripts/simplify/simplify_loss_prev.py --filename "semi-complex-im.jpeg" --res_filename "ViT_l11_64s_semi-complex_mask" --layer_opt 11 --gradnorm 1 --load_points_opt_weights 0
# CUDA_VISIBLE_DEVICES=3 python scripts/simplify/simplify_loss_prev.py --filename "semi-complex-im.jpeg" --res_filename "ViT_l8_64s_semi-complex_mask" --layer_opt 8 --gradnorm 1 --load_points_opt_weights 0
# CUDA_VISIBLE_DEVICES=0 python scripts/simplify/simplify_loss_prev.py --filename "semi-complex-im.jpeg" --res_filename "ViT_l4_64s_semi-complex_mask" --layer_opt 4 --gradnorm 1 --load_points_opt_weights 0
...
for i, w in enumerate(weights):
    ...
    sp.run(["python", 
            "scripts/simplify/run_sketch.py", 
            "--target_file", file_,
