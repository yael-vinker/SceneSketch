...
# ======= commands ========
# =========================
# CUDA_VISIBLE_DEVICES=2 python scripts/simplify/simplify_loss_prev_b.py --im_name "woman_city" --layer_opt 11
# CUDA_VISIBLE_DEVICES=2 python scripts/simplify/simplify_loss_prev_b.py --im_name "man_flowers" --layer_opt 8
# CUDA_VISIBLE_DEVICES=3 python scripts/simplify/simplify_loss_prev_b.py --im_name "van" --layer_opt 8

# CUDA_VISIBLE_DEVICES=4 python scripts/simplify/simplify_loss_prev_b.py --im_name "van" --layer_opt 4
# CUDA_VISIBLE_DEVICES=5 python scripts/simplify/simplify_loss_prev_b.py --im_name "man_flowers" --layer_opt 4
