...
# CUDA_VISIBLE_DEVICES=5 python scripts/width_and_points/baseline_vit1.py --image "london_mask.png"
...
images = ["japan_mask.png", "chicks_mask.png", "boat_tree_mask.png", "sunset_mask.png"]
