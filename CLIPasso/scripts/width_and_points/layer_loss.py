...
# ======= commands ========
# =========================
# CUDA_VISIBLE_DEVICES=4 python scripts/width_and_points/layer_loss.py --filename "complex-scene-crop-back-l4.png" --res_filename "ViT_l4_64s_complex-scene-crop_mask" --layer_opt 4

# CUDA_VISIBLE_DEVICES=2 python scripts/width_and_points/layer_loss.py --filename "complex-scene-crop-back-l11.png" --res_filename "ViT_l11_64s_complex-scene-crop_mask" --layer_opt 11
# CUDA_VISIBLE_DEVICES=7 python scripts/width_and_points/layer_loss.py --filename "semi-complex-back-l11.png" --res_filename "ViT_l11_64s_semi-complex_mask" --layer_opt 11
# CUDA_VISIBLE_DEVICES=6 python scripts/width_and_points/layer_loss.py --filename "semi-complex-im.jpeg" --res_filename "ViT_l11_64s_semi-complex_mask" --layer_opt 11



# CUDA_VISIBLE_DEVICES=4 python scripts/width_and_points/layer_loss.py --filename "complex-scene-crop-back-l9.png" --res_filename "ViT_l9_64s_complex-scene-crop_mask" --layer_opt 4
# CUDA_VISIBLE_DEVICES=4 python scripts/width_and_points/layer_loss.py --filename "complex-scene-crop-back-l9.png" --res_filename "ViT_l9_64s_complex-scene-crop_mask" --layer_opt 9
# CUDA_VISIBLE_DEVICES=4 python scripts/width_and_points/layer_loss.py --filename "complex-scene-crop-back-l8.png" --res_filename "ViT_l8_64s_complex-scene-crop_mask" --layer_opt 4
# CUDA_VISIBLE_DEVICES=4 python scripts/width_and_points/layer_loss.py --filename "complex-scene-crop-back-l8.png" --res_filename "ViT_l8_64s_complex-scene-crop_mask" --layer_opt 8

# CUDA_VISIBLE_DEVICES=2 python scripts/width_and_points/layer_loss.py --filename "semi-complex-back-l4.png" --res_filename "ViT_l4_64s_semi-complex_mask" --switch_loss 20
...
path_res_pref = "/home/vinker/dev/background_project/experiements/width_21_07/"
...
for i, w in enumerate(weights):
    ...
    if i == 0:
        ...
        mlp_width_weights_path = f"{output_pref}/width{weights[i-1]}_{test_name_pref}_{num_strokes}s_{os.path.splitext(os.path.basename(file_))[0]}/width_mlp.pt"
