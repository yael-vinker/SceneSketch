...
# ================
# CUDA_VISIBLE_DEVICES=1 python scripts/width_opt/width_opt_loss.py --image "house_layer4.png" --clip_conv_loss_type "Cos" --width_loss_type "L1_hinge"
# CUDA_VISIBLE_DEVICES=7 python scripts/width_opt/width_opt_loss.py --image "house_layer4.png" --clip_conv_loss_type "L2" --width_loss_type "L1"
# CUDA_VISIBLE_DEVICES=1 python scripts/width_opt/width_opt_loss.py --image "house_layer4.png" --clip_conv_loss_type "L2" --width_loss_type "L1_hinge"


# source_im_name="semi-complex_mask"
source_im_name="complex-scene-crop_mask"
# buildings
...
for j, layer in enumerate(layers):
    file_ = f"{path_to_files}/buildings_layer{layer}.png"
    start_l = time.time()
