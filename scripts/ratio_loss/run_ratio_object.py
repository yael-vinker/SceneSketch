...
# CUDA_VISIBLE_DEVICES=2 python scripts/ratio_loss/run_ratio_object.py --im_name "woman_city" --layer_opt 2 --run_ratio 1 --weihts_str "25.1,18.74,15.74,10.1,5.595,3.95,2.7,1.6,1.25"
