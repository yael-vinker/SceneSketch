...
# CUDA_VISIBLE_DEVICES=7 python scripts/resnet_vs_vit/vit.py
# CUDA_VISIBLE_DEVICES=2 python scripts/resnet_vs_vit/vit.py --im_name "assaf.jpg" --mask 1 --num_strokes 16
...
for i in layers:
    ...
    test_name = f"{model[:3]}_l{i}_{num_strokes}s_mask{mask_object}_{os.path.splitext(os.path.basename(file_))[0]}"
    sp.run(["python", 
