...
# CUDA_VISIBLE_DEVICES=2 python scripts/resnet_vs_vit/vit_fc.py
...
clip_conv_layer_weights_int[11] = 0.1
...
for im_name in images:
    ...
    test_name = f"{model[:3]}_l1_l2_l11-01_{num_strokes}s_mask{mask_object_attention}_{os.path.splitext(os.path.basename(file_))[0]}"
    sp.run(["python", 
