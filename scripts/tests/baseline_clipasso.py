...
# CUDA_VISIBLE_DEVICES=6 python scripts/tests/baseline_clipasso.py
...
# output_pref = f"/home/vinker/dev/background_project/experiements/width_20_07"
# loss_mask = "none"
# mask_object_attention = 0
# # ===================
...
for im_name in images:
        ...
        test_name = f"{model[:3]}_{num_strokes}s_mask{mask_object_attention}_{os.path.splitext(os.path.basename(file_))[0]}"
        print(test_name)
        sp.run(["python", 
