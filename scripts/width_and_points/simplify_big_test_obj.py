...
# ======= commands ========
# =========================
#CUDA_VISIBLE_DEVICES=2 python scripts/width_and_points/simplify_big_test_obj.py --im_name "van"
#CUDA_VISIBLE_DEVICES=7 python scripts/width_and_points/simplify_big_test_obj.py --im_name "boat_tree"
...
# for l_ in layers:
# points1_width_L1_0.0004__switch5_clip_l4L2__64s_panda
# points1_width_L1_0.0001__switch5_clip_l4L2__64s_woman_city_l11back_seed1000
filename = f"{args.im_name}.png"
res_filename = f"RN1_64s_{args.im_name}"
start_l = time.time()
