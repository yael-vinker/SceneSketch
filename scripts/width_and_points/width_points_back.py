...
# ======= commands ========
# =========================
# CUDA_VISIBLE_DEVICES=4 python scripts/width_and_points/width_points_back.py --filename "complex-scene-crop-back-l4.png" --res_filename "ViT_l4_64s_complex-scene-crop_mask" --switch_loss 20
# CUDA_VISIBLE_DEVICES=2 python scripts/width_and_points/width_points_back.py --filename "semi-complex-back-l4.png" --res_filename "ViT_l4_64s_semi-complex_mask" --switch_loss 20

# CUDA_VISIBLE_DEVICES=1 python scripts/width_and_points/width_points_back.py --filename "complex-scene-crop-back-l11.png" --res_filename "ViT_l11_64s_complex-scene-crop_mask" --switch_loss 10
# CUDA_VISIBLE_DEVICES=6 python scripts/width_and_points/width_points_back.py --filename "semi-complex-back-l11.png" --res_filename "ViT_l11_64s_semi-complex_mask" --switch_loss 10

# ViT_l4_64s_complex-scene-crop_mask
# complex-scene-crop-back-l4.png
# 4, ,6,8,11
